...
/**
 * This is the model class for table "row_row_id_seq".
 *
 * The followings are the available columns in table 'row_row_id_seq':
 ...
 */
class RowRowIdSeq extends CActiveRecord
{
	/**
	 ...
	 * @return RowRowIdSeq the static model class
	 */
