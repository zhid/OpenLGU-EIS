...
/**
 * This is the model class for table "column_column_id_seq".
 *
 * The followings are the available columns in table 'column_column_id_seq':
 ...
 */
class ColumnColumnIdSeq extends CActiveRecord
{
	/**
	 ...
	 * @return ColumnColumnIdSeq the static model class
	 */
