...
/**
 * This is the model class for table "measure_measure_id_seq".
 *
 * The followings are the available columns in table 'measure_measure_id_seq':
 ...
 */
class MeasureMeasureIdSeq extends CActiveRecord
{
	/**
	 ...
	 * @return MeasureMeasureIdSeq the static model class
	 */
